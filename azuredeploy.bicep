...
@description('Git repository URL for the application source. This defaults to the [`mihailmateev/VectorSearchAiAssistant`](https://github.com/AzureCosmosDB/VectorSearchAiAssistant) repository.')
param appGitRepository string = 'https://github.com/mihailmateev/VectorSearchAiAssistant.git'
